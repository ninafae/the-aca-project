...
$meta_box_quote = array(
	...
	'title' =>  __('Quote Settings', 'theme1619'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The Quote','theme1619'),
				"desc" => __('Put your quote in this field.','theme1619'),
				"id" => $prefix."quote",
				"type" => "textarea"
			),
	),
...
$meta_box_link = array(
	'id' => 'tz-meta-box-link',
	'title' =>  __('Link Settings', 'theme1619'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('The URL','theme1619'),
				"desc" => __('Insert the URL you wish to link to.','theme1619'),
				"id" => $prefix."link_url",
				"type" => "text"
			),
	),
...
$meta_box_image = array(
	...
	'title' =>  __('Image Settings', 'theme1619'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Enable Lightbox','theme1619'),
				"desc" => __('Check this to enable the lightbox.','theme1619'),
...
$meta_box_audio = array(
	...
	'title' =>  __('Audio Settings', 'theme1619'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('MP3 File URL','theme1619'),
				"desc" => __('The URL to the .mp3 audio file','theme1619'),
				"id" => $prefix."audio_mp3",
				"type" => "text"
			)
	),
...
$meta_box_video = array(
	...
	'title' =>  __('Video Settings', 'theme1619'),
	'page' => 'post',
	'context' => 'normal',
	'priority' => 'high',
	'fields' => array(
		array( "name" => __('Embeded Code','theme1619'),
				"desc" => __('You can include embeded code here.','theme1619'),
