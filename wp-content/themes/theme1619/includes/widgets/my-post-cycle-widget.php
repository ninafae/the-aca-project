...
class MY_CycleWidget extends WP_Widget {
    ...
    function widget($args, $instance) {		
        ...
        ?>
              ...
              <div id="testi-controls">
                <a href="#"><span id="prev-testi"><?php _e('Prev', 'theme1619'); ?></span></a> 
                <a href="#"><span id="next-testi"><?php _e('Next', 'theme1619'); ?></span></a>
                <ul id="nav-testi"></ul>
              </div>
							<!-- end of testimonials -->
                ...
                <div class="folio_item">
									...
									<?php if(has_post_thumbnail()) { ?>
										...
										$image = aq_resize( $img_url, 298, 150, true ); //resize & crop img
										?>
    ...
    ?>
      ...
      <p><label for="<?php echo $this->get_field_id('limit'); ?>"><?php _e('Limit Text:', 'theme1619'); ?> <input class="widefat" id="<?php echo $this->get_field_id('limit'); ?>" name="<?php echo $this->get_field_name('limit'); ?>" type="text" value="<?php echo $limit; ?>" /></label></p>
      ...
      <p><label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Type of posts:', 'theme1619'); ?><br />
