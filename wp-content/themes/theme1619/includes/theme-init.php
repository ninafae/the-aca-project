...
function my_setup() {
	...
	if ( function_exists( 'add_theme_support' ) ) { // Added in 2.9
		...
		set_post_thumbnail_size( 278, 218, true ); // Normal post thumbnails
		add_image_size( 'slider-post-thumbnail', 940, 439, true ); // Slider Thumbnail
	}
...
function my_post_type_slider() {
	register_post_type( 'slider',
                array( 
				'label' => __('Slides'), 
				'singular_label' => __('Slide', 'theme1619'),
				'_builtin' => false,
...
function my_post_type_portfolio() {
	register_post_type( 'portfolio',
                array( 
				'label' => __('Portfolio'), 
				'singular_label' => __('Porfolio Item', 'theme1619'),
				'_builtin' => false,
				'public' => true, 
				'show_ui' => true,
...
function my_post_type_team() {
	register_post_type( 'team',
                array( 
				'label' => __('Our Team'), 
				'singular_label' => __('Person', 'theme1619'),
				'_builtin' => false,
				'exclude_from_search' => true, // Exclude from Search Results
				'capability_type' => 'page',
				'public' => true, 
