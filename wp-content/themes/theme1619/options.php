...
function optionsframework_options() {
	...
	// Logo type for Footer
	$logo_type_footer = array("image_logo" => "Image Logo","text_logo" => "Text Logo");
	...
	$options[] = array( "name" => "What kind of Footer logo?",
						"desc" => "Select whether you want your main logo to be an image or text. If you select 'image' you can put in the image url in the next option, and if you select 'text' your Site Title will show instead.",
						"id" => "logo_type_footer",
						"std" => "image_logo",
						"type" => "radio",
						"options" => $logo_type_footer);
	
	$options[] = array( "name" => "Footer Logo URL",
						"desc" => "Enter the direct path to your logo image. For example http://your_website_url_here/wp-content/themes/themeXXXX/images/logo-footer.png",
						"id" => "logo_footer_url",
						"type" => "upload");
