...
<div id="content" class="grid_8 <?php echo of_get_option('blog_sidebar_pos') ?>">
  ...
  <div class="author-info">
    <h1><?php _e('About:', 'theme1619'); ?> <?php echo $curauth->display_name; ?></h1>
    <p class="avatar">
  ...
  <div id="recent-author-posts">
    <h3><?php _e('Recent Posts by', 'theme1619'); ?> <?php echo $curauth->display_name; ?></h3>
		...
		if (have_posts()) : while (have_posts()) : the_post(); 
		 ...
		 <div class="no-results">
			<?php echo '<p><strong>' . __('No post yet.', 'theme1619') . '</strong></p>'; ?>
		</div><!--no-results-->
  ...
  <div id="recent-author-comments">
    <h3><?php _e('Recent Comments by', 'theme1619'); ?> <?php echo $curauth->display_name; ?></h3>
      <?php
      ...
      <ul>
        ...
        endforeach; else: ?>
                  <p>
                    <?php _e('No comments by', 'theme1619'); ?> <?php echo $curauth->display_name; ?> <?php _e('yet.', 'theme1619'); ?>
                  </p>
        <?php endif; ?>
            </ul>
